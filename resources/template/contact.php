<?php
    ...
    function send_mail($to, $subject, $message, $headers)
    {
        if (@mail($to, $subject, $message, $headers)) {
            echo json_encode(['info' => 'success', 'msg' => __SUCCESS_MESSAGE__]);
        } else {
            echo json_encode(['info' => 'error', 'msg' => __ERROR_MESSAGE__]);
        }
    }
    ...
    if (isset($_POST['name']) and isset($_POST['mail']) and isset($_POST['comment'])) {
        ...
        if ($name == '') {
            ...
            exit();
        } elseif ($mail == '' or check_email($mail) == false) {
        ...
        echo json_encode(['info' => 'error', 'msg' => __MESSAGE_EMPTY_FILDS__]);
    }
